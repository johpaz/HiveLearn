...
export const COLORS = {
  ...
  hologramAlpha: 0.3,
  coordinator: 0xfbbf24,       // Color del coordinador
}
...
export const ROBOT_CONFIG = {
  ...
  acceleration: 300,
  rotationSpeed: 3,
  // Animation fields (merged from ANIMATION_CONFIG for RobotSprite)
  hoverAmplitude: 2,
  hoverFrequency: 1.5,
  blinkInterval: [2, 5] as [number, number],
  blinkDuration: 0.15,
  antennaBlinkInterval: [0.5, 2] as [number, number],
  wheelRotationSpeed: 5,
  armWaveSpeed: 4,
